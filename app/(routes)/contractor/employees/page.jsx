...
function ContractorEmployees({ params: { slug } }) {
  ...
  console.log(profile?.companies?.company_workers);
    ...
    <div className="p-3">
      <div>
        ...
        {isLoadingUser ? (
          ...
          // BUG: The user table is not referencing the workers slug. It should be referencing the workers slug
          // The link should be `/contractor/employees/${params.slug}/`
          // Switching to slug will solve the issue
          <UserTable
